...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2023 at 03:05 AM
...
(20, 2019, '2019-ADMISSION-TEST.docx', 11869, 1);
...
(36, '2001911-M', 'bin Laden, Osama', 'ISIS 4-A', '', '', '', '2022-10-26 07:10:27.760490', 'no', 'user', 0, 'Screenshot 2023-01-16 133025.jpg', ''),
...
(150, 'testuser-1', 'Test, User 1', 'BSOS', 'xbxffdcen@eurokool.com', '5d9c68c6c50ed3d02a2fcf54f63993b6', '', '2023-02-15 01:16:36.362485', 'yes', 'user', 1, 'Screenshot 2023-02-08 131652.jpg', '');
...
--
ALTER TABLE `tbl_activitylog`
  MODIFY `activityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;

--
-- AUTO_INCREMENT for table `tbl_admissiontestrecords`
--
ALTER TABLE `tbl_admissiontestrecords`
  MODIFY `admID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tbl_admissiontestschedule`
--
ALTER TABLE `tbl_admissiontestschedule`
  MODIFY `admID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_counselors`
  MODIFY `counselorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_proctorschedule`
  MODIFY `proctorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `tbl_sanctions`
  MODIFY `sanctionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_sanctionservices`
--
ALTER TABLE `tbl_sanctionservices`
  MODIFY `sanctionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
