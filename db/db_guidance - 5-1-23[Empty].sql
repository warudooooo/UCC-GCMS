...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2023 at 12:39 PM
...
(106, 'Psychological Assessment', 'Reyes, Romulado M.', '20190084-M', 'BSIS 4-A', 'romualdoreyes2301@gmail.com', '106', 'May 25, 2023 12:00 PM (Thursday)', 'Completed', 'Joey De Leon', 'adssaddsa', '2023-05-01 18:37:58');
...
(31, 'Reyes, Romulado M.', '20190084-M', 'BSIS 4-A', 'romualdoreyes2301@gmail.com', 'No ID, No Entry Policy', 'Written reprimand', 'sadasdasdsdaasd', '2023-05-01 17:23:32', 'Mild', 'Pending'),
(32, 'Reyes, Romulado M.', '20190084-M', 'BSIS 4-A', 'romualdoreyes2301@gmail.com', 'Libelous, Subversive and Defamatory Acts', 'Warning', '', '2023-05-01 17:23:45', 'Moderate', 'Completed');
...
(177, '23019as-M', 'sfdsfd', 'bsis 4-a', '', '', '', '2023-04-30 10:20:47.948968', 'no', 'user', 1, '', '', ''),
(178, '20120012-M', 'sadsadsa', 'bsds 4-a', '', '', '', '2023-04-30 10:42:09.591286', 'no', 'user', 1, '', '', ''),
(179, '2342342342', 'asdasdsa', 'BSIS 4-A', '', '', '', '2023-05-01 07:55:50.555744', 'no', 'user', 1, '', '', '');
...
(751, '20191542-M', 'Aquino, Christine Joy Gomez', 'BSIS 4-A', '1161 RD.3 Tambakan St. Maypajo Caloocan City', 'achristinejoy126@gmail.com', '(+63) 9217054443', 'Irregular'),
...
--
ALTER TABLE `tbl_activitylog`
  MODIFY `activityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=921;
...
--
ALTER TABLE `tbl_counselors`
  MODIFY `counselorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_proctors`
--
ALTER TABLE `tbl_proctors`
  MODIFY `proctorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_proctorschedule`
--
ALTER TABLE `tbl_proctorschedule`
  MODIFY `proctorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `tbl_sanctions`
  MODIFY `sanctionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `tbl_sanctionservices`
--
ALTER TABLE `tbl_sanctionservices`
  MODIFY `sanctionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
