...
include 'sources/src-maintenance-Case.php';
?>
<!DOCTYPE html>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title"><i class="mdi mdi-account-multiple"></i> Case Lists</h4>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $load->fetch_assoc()) {
                                            echo "<tr>
                                                 ...
                                                 <button style='width: 150px;' type='button' class='btn btn-primary deletebtn procdelbtn' data-bs-toggle='modal' data-bs-target='#deleteCaseModal'>
                                                     DELETE
                                                 </button></td>
                                                 </tr>";
                                            $i++;
