                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" placeholder="(EX: Dela Cruz, Juan M.)" name="studentName" style="background-color: #edf2fb;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Student Number</label>
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" placeholder="(Ex: 20xxxxxx-M)" name="studentNumber" style="background-color: #edf2fb; text-transform: uppercase;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Course, Year and Section</label>
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" placeholder="(Ex: BSxx 1-A)" name="studentCourse" style="background-color: #edf2fb; text-transform: uppercase;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Address</label>
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" id="" placeholder="" name="studentAddress" style="background-color: #edf2fb;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" id="" placeholder="" name="studentEmail" style="background-color: #edf2fb;" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Phone number</label>
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" id="" placeholder="" name="studentPhone" style="background-color: #edf2fb;" required></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content approve">
                ...
                <div class="form-group">
                        <label class="col-md-12">Status</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentStatus" placeholder="" style="background-color: #edf2fb; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Student Name</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentName" placeholder="" style="background-color: #edf2fb; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Student Number</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentNumber" placeholder="" style="background-color: #edf2fb; text-transform: uppercase; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Course, Year and Section</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentCourse" placeholder="" style="background-color: #edf2fb; text-transform: uppercase; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Address</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentAddress" placeholder="" style="background-color: #edf2fb; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Email</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentEmail" placeholder="" style="background-color: #edf2fb; pointer-events: none;" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Phone number</label>
                        <div class="col-md-12">
                            <textarea rows="1" class="form-control form-control-line" id="studentPhone" placeholder="" name="studentPhone" style="background-color: #edf2fb; pointer-events: none;" required></textarea>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content approve">
                ...
                <div class="modal-footer" style="margin:auto;">
                    <button type="submit" class="btn btn-primary mdladdbtn" style="width: 200px;" name="importExcelFile">Import</button>
