        ...
        <div class="modal-dialog">
            <div class="modal-content seemore">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <textarea rows="3" class="form-control form-control-line" id="sancCase" style="background-color: #e8eddf; padding: 20px; pointer-events: auto;" readonly></textarea>
                    </div>
                    <h5 class="col-md-12" style="margin-top:10px;">Guidance Message</h5>
                    <div class="col-md-12">
                        <textarea rows="8" class="form-control form-control-line" id="guideMessage" style="background-color: #e8eddf; padding: 20px; pointer-events: auto;" readonly></textarea>
                        <input id="ssID" name="ssID" style="display: none;">
                    </div>
                </div>
                <div class="modal-footer" style="margin: auto;">
                    <button style="width: 200px;" type="submit" class="btn btn-secondary btnblue markasdone" name="sancMarkAsDone">Mark as Done</button>
