        ...
        <div class="modal-dialog">
            <div class="modal-content approve">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="1" class="form-control form-control-line" name="pName" style="background-color: #edf2fb;" maxlength="40" required></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary mdladdbtn" name="addproctor">Add Proctor</button>
    ...
    <div class="modal fade" id="editProctorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content approve">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary mdladdbtn" name="editproctor">Submit</button>
                    <button type="button" class="btn btn-secondary mdlclosebtn" data-bs-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="viewProctorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content approve">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary mdladdbtn" style="width: 130px;"formaction="proctors-schedule.php" value="viewsched" name="viewsched">View</button>
                    <button type="button" class="btn btn-secondary mdlclosebtn" data-bs-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="deleteProctorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content approve">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary yesbtn" style="width: 130px;" name="deleteproctor">Delete</button>
                    <button type="button" class="btn btn-secondary mdlclosebtn" data-bs-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
