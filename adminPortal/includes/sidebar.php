    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <hr class="hr" /> -->
                <h4 class="col-md-12" style="margin-top:10px; margin-left:25px;">Appointments</h4>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="appointmentsDashboard.php" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="appointmentStatistics.php" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Appointment Statistics</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="sanctionStatistics.php" aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Student Sanctions Statistics</span></a></li>
                <hr class="hr" />
