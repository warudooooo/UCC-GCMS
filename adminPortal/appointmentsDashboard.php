            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- Event Details Modal -->
                        <?php
                        $schedules = $mysqli->query("SELECT ID,counselingStatus,counselingType,requesterName,counselingSchedule,studentNumber FROM `tbl_counselings` WHERE counselingStatus != 'Declined' AND counselingStatus != 'Cancelled'");
                        $sched_res = [];
