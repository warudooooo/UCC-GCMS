        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h4 class="page-title"><i class="mdi mdi-calendar-multiple-check"></i> Administrive Offenses and Penalties</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                ...
                                <h5 class="page-title" style="margin-top: 5px;">This is based on the University's Student Handbook. ( ARTICLE VI. ADMINISTRATIVE OFFICES AND SERVICES (Section 4) )</h5>
                            </nav>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card" style="border-radius: 20px !important;">
                            <div class="card-body" style="border-radius: 20px !important; background-color: #ffe0cc;">
                                ...
                                <div class='form-group' style='margin: auto; text-align: center;'>
                                        <label class='aboutlbl'>" . $row["serviceName"] . "</label>
                                        <div class='col-md-12' style='width: 100%; margin-top: 20px;'>
                                            <textarea class='aboutdesc' rows='3' class='form-control form-control-line' readonly>" . $row["serviceDetails"] . "</textarea>
                                        </div>
                                </div>
                                <hr class='hr line' />
                                ";
