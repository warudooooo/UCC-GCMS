        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title"><i class="mdi mdi-calendar-multiple-check"></i> Sanctions </h4>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                <div class="row">
                        <h4 class="page-title" style="margin-top: 20px; margin-bottom: 20px; display: block !important;"><i class="mdi mdi-account-wrench"></i> Sanctions </h4>
