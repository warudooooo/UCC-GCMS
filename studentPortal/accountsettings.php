                                    ...
                                    <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                                        <form method="POST" action="" autocomplete="off">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Student Number (Send Request to admin for changes)</label>
                                                        <input type="text" class="form-control" value="<?php echo $sNumber ?>" name="sNumber" style="pointer-events: none;" readonly required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Course, Year and Section</label>
                                                        <input type="text" class="form-control" value="<?php echo $sCourse ?>" name="sCourse" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
